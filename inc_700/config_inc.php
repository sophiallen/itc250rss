...
define('VIRTUAL_PATH', 'http://www.sophiallen.com/itc250/itc250rss/'); # Virtual (web) 'root' of application for images, JS & CSS files
define('PHYSICAL_PATH', '/home/sophiallen/sophiallen.com/itc250/itc250rss/'); # Physical (PHP) 'root' of application for file & upload reference
...
define('SUPPORT_EMAIL', 'email@gmail.com'); # Email of site support
...
$config->style = 'cosmo.css'; #currently only Bootswatch Theme uses style to switch look & feel
$config->slogan = 'Read-Simple News: Read Simply with Style.';
$config->metaDescription = 'Read-Simple News: Read Simply with Style.';
$config->metaKeywords = 'RSS, ITC250, database,mysql,php';
